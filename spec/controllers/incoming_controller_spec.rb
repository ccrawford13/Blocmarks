...
RSpec.describe IncomingController, type: :controller do
  describe 'Post#create with Mailgun params' do
    ...
    let(:receive_email) do
      post :create, 'body-plain' => 'http://google.com/new_rails_gem', subject: 'New Rails Gem', sender: 'user@example.com'
    end

    let(:email_from_registered_user) do
      post :create, 'body-plain' => 'http://google.com/rails5', subject: 'Rails 5 Released!', sender: 'user@example.com'
    end

    let(:email_with_existing_topic) do
      post :create, 'body-plain' => 'http://rubygems.org', subject: 'Rails 5 Released!', sender: 'user@example.com'
    end
